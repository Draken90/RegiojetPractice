        ...
        <div class="navbar navbar-fixed-top container-fluid head-colr">
            ...
            <div class="col-md-9">
                <h2 class="header-title">
                    <xsl:value-of select="$reportHeading"/> for
                    <xsl:value-of select="$currentSuiteName"/>
                </h2>
            </div>
            <div class="col-md-3 gap-top-small">
                <span class="refresh btn btn-success" title="Refresh">
        ...
        <div class="container-fluid">
            <div class="container gap-below gap-top">
                <div class="progress">
                    <div class="progress-bar progress-bar-info" role="progressbar" aria-valuemin="0"
                         aria-valuemax="100">
                        <script>getProgress('<xsl:value-of select="$percentComplete"/>')
                        </script>
                    </div>
                </div>
            </div>
            <div class="container gap-below">
                <div class="col-md-4 gap-small-bottom">
                    <div class="r3_counter_box">
                        ...
                        <div class="stats">
                            <h5 id="passPer">
                                <script>getPercent('<xsl:value-of select="$passedPercent"/>','passPer')
                                </script>
                                <span>%</span>
                            </h5>
                            <div class="grow">
                ...
                <div class="col-md-4 gap-small-bottom">
                    <div class="r3_counter_box">
                        ...
                        <div class="stats">
                            <h5 id="failPer">
                                <script>getPercent('<xsl:value-of select="$failPercent"/>','failPer')
                                </script>
                                <span>%</span>
                            </h5>
                ...
                <div class="col-md-4">
                    <div class="r3_counter_box">
                        ...
                        <div class="stats">
                            <h5 id="skipPer">
                                <script>getPercent('<xsl:value-of select="$skippedPercent"/>','skipPer')
                                </script>
                                <span>%</span>
                            </h5>
            ...
            <div class="container gap-below">
                ...
                <script>
                    ...
                    datasets: [
                    {
                    data: ['<xsl:value-of select="$passedMethods"/>', '<xsl:value-of select="$failedMethods"/>',
                    '<xsl:value-of select="$skippedMethods"/>'],
                    backgroundColor: [
                    "#8bc34a",
                    "#f44336",
                    "#ffca28"
                    ...
                    <div class="col-md-6 highlight fix-height">
                        <div class="r3_counter_box red">
                            ...
                            <p class="number right font-600" id="totTm">
                                <script>getHMS('<xsl:value-of select="$executionTime"/>','totTm')
                                </script>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="r3_counter_box inner-gap">
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="filter-area gap-below">
                                <p>Filter By :
                                    <form>
                                        <input type="radio" name="filter" value="group" checked="checked"><i
                                                class="fa fa-users"></i>Group
                                        </input>
                                        <input type="radio" name="filter" value="class"><i class="fa fa-book"></i>Test
                                            Class
                                        </input>
                                        <input type="radio" name="filter" value="verdict"><i
                                                class="fa fa-balance-scale"></i>Verdict
                                        </input>
                                        <input type="radio" name="filter" value="config">
                            ...
                            <div class="alert alert-info">
                                <strong>Showing <i id="show"></i> results
                                </strong>
                            </div>
                            <div class="panel-group accordian-top-margin" id="Accordion" role="tablist"
                                ...
                                <xsl:for-each select="/testResults/testResult">
                                    ...
                                    <div class="panel accordian-panel-heading" id="{$getId}" title="{$verdict}"
                                         style="display:none;">
                                        ...
                                        <div id="collapse{$index}" class="panel-collapse collapse" role="tabpanel"
                                            ...
                                            <div class="panel-body panel_text panel-body-new">
                                                ...
                                                <p>
                                                    ...
                                                    <i id="dura{$index}">
                                                        <script>getHMS('<xsl:value-of
                                                                select="$duration"/>','dura<xsl:value-of
                                                                select="position()"/>')
                                                        </script>
                                                    </i>
                                                </p>
                                ...
                                <xsl:for-each select="/testResults/configurationMethod">
                                    ...
                                    <xsl:variable name="parameter" select="methodParameter"/>
                                    <xsl:variable name="exception" select="methodErrorCause"/>
                                    <div class="panel accordian-panel-heading" id="config" title="{$verdict}"
                                         style="display:none;">
                                        <div class="panel-heading" role="tab" id="cheading{$index}">
                                            <h4 class="nw-page-title">
                                                <a class="pa_italic" role="button" data-toggle="collapse"
                                                   data-parent="#Accordion" href="#ccollapse{$index}"
                                                   aria-expanded="true" aria-controls="collapseOne">
                                                    <span class="fa fa-chevron-down"></span>
                                                    <span class="fa fa-chevron-up"></span>
                                                    <label>
                                        ...
                                        <div id="ccollapse{$index}" class="panel-collapse collapse" role="tabpanel"
                                             aria-labelledby="cheading{$index}">
                                            <div class="panel-body panel_text panel-body-new">
                                                <p>
                                                    <strong>Name:</strong>
                                                    <xsl:value-of select="$name"/>
                                                ...
                                                <p>
                                                    ...
                                                    <xsl:value-of select="$getAnnotation"/>
                                                </p>
                                                <p>
                                                    <strong>Instance:</strong>
                                                    <xsl:value-of select="$instance"/>
                                                ...
                                                <p>
                                                    ...
                                                    <i id="cdura{$index}">
                                                        <script>getHMS('<xsl:value-of
                                                                select="$duration"/>','cdura<xsl:value-of
                                                                select="position()"/>')
                                                        </script>
                                                    </i>
                                                </p>
